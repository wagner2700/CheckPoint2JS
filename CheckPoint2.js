...
function Aluno(nome, qtdFaltas, notas) {
  ...
  this.calculaMedia = function() {
      ...
      aluno.media = (notasTotal / this.notas.length).toFixed(2) 
...
const Wagner   =  new Aluno('Wagner' , 20, [6,8,7,9])
...
let curso = {
  ...
  aprovado: function(aluno) {
      ...
      let media =(notas.reduce((prev, curr) => prev + curr) / notas.length).toFixed(2)


      if ( faltas <= this.faltasMax &&
